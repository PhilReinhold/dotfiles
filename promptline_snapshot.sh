...
function __promptline_right_prompt {
  ...
  slice_prefix="${c_sep_fg}${rsep}${c_fg}${c_bg}${space}" slice_suffix="${c_bg}$space${c_sep_fg}" slice_joiner="${c_fg}${c_bg}${alt_rsep}${space}" slice_empty_prefix=""
  __promptline_wrapper "$(vi_mode_prompt_info)" "$slice_prefix" "$slice_suffix" && { slice_prefix="$slice_joiner"; }
  #__promptline_wrapper "$KEYMAP" "$slice_prefix" "$slice_suffix" && { slice_prefix="$slice_joiner"; }
